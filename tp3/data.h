...
public:
    ...
    const Location & y       () const {
        return y_;
    }
    const Load &     demand  () const {
        return demand_;
    }
...
public:
    ...
    const Time & cost () const {
        return cost_;
    }

    const Time & saving () const {
        return saving_;
    }
    Time & saving () {
        return saving_;
...
public:
    ...
    const bool & has_coordinates () const {
    ...
    const Load &     fleetCapacity () const {
        return capacity_;
    }
    unsigned   nb_nodes      () const {
        return nodes_.size();
    }
    unsigned   nb_clients    () const {
        return nodes_.size() - 1;
    }
    const Id &       depot         () const {
        return depot_;
    }
    const Time &     services      () const {
        return total_services_;
    }
    const Cvector  & nodes         () const {
        return nodes_;
    }
    const Customer & node          (const Id & i) const {
        return nodes_[i];
    }
    const Avector &  arcs          () const {
        return arcs_;
    }
    //const Arc &      arc           (const Id & i, const Id & j) const {return arcs_[0];}
    Time       distance      (const Id & i, const Id & j) const {
        return distance_[i][j];
    }
    bool       is_valid      (const Id & i, const Id & j) const {
        return is_valid_[i][j];
    }
};
